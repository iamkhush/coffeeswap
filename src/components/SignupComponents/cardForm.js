      ...
      <form onSubmit={this.handleSubmit}>
        ...
        { 
          this.state.showAddressForm == true ? '': (
              <div className="row">
                  <h1>Enter Billing Address Details</h1>
                  <div className="col-lg-3 col-lg-offset-1">
                    ...
                    <textarea onChange={this.handleInputChange} className="form-control" name="billing_address" required />
                    <label htmlFor="state" className="getStartedColor col-3 col-form-label">State</label>
                    <select className="form-control" id="user_shipping_state" name="billing_state" onChange={this.handleInputChange}>
                      <option value=""></option>
                  ...
                  <div className="col-lg-4 col-lg-offset-2">
                    <div className="form-group row">
                      ...
                      <div className="col-3">
                        <input onChange={this.handleInputChange} className="form-control" name="billing_city" type="text" required />
                      </div>
                      <label  htmlFor="zipcode" className="getStartedColor col-3 col-form-label">Zip Code</label>
                      <div className="col-3">
                        <input onChange={this.handleInputChange} className="form-control" name="billing_zipcode" type="text" required />
                      </div>
                      <label  htmlFor="country" className="getStartedColor col-3 col-form-label">Country</label>
                      <div className="col-3">
                        <select onChange={this.handleInputChange} name="billing-country" className="form-control">
                          <option value=""></option>
