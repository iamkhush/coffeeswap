		        ...
		        <div className="col-lg-2 col-lg-offset-3">
		            <div className="form-group row">
			            ...
			            <div className="col-3">
							...
							<span style={{color:'red', display:this.props.showError.password?'block':'none'}}>Please use an 8 character password with one uppercase letter and one number</span>
						</div>                
