...
const ShippingDetails = ({...props}) => {
	return (
		<div className="row">
            <h4 className="getStartedColor col-lg-offset-2 ab-mt5">Enter Billing Address Details</h4>
            <div className="col-lg-3 col-lg-offset-1">
                ...
                <textarea onChange={props.handleInputChange} className="form-control" name="billing_address" required />
                <label htmlFor="state" className="getStartedColor col-3 col-form-label">State</label>
                <select className="form-control" id="user_shipping_state" name="billing_state" onChange={props.handleInputChange}>
                      <option value=""></option>
			...
			<div className="col-lg-4 col-lg-offset-2">
				<div className="form-group row">
				  ...
				  <div className="col-3">
				    <input onChange={props.handleInputChange} className="form-control" name="billing_city" type="text" required />
				  </div>
				  ...
				  <div className="col-3">
				    <select onChange={props.handleInputChange} name="billing-country" className="form-control">
				      <option value=""></option>
